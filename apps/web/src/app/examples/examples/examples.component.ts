...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'dr.examples.menu.todos' },
    { link: 'stock-market', label: 'dr.examples.menu.stocks' },
    { link: 'theming', label: 'dr.examples.menu.theming' },
    { link: 'crud', label: 'dr.examples.menu.crud' },
    { link: 'form', label: 'dr.examples.menu.form' },
    { link: 'authenticated', label: 'dr.examples.menu.auth', auth: true }
  ];
